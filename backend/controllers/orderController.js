...
// this is not secure method, it should be done using webhook
// but for now we are using this method to verify payment
// in future we will implement webhook method
